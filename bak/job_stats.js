new Vue({
  ...
  data: {
    ...
    columns: [
      {title: 'Job URL', field: 'url', sortable: true},
      {title: 'CronTable', field: 'timerTrigger', thStyle: 'width="12%"'},
      {title: 'Node', field: 'node', thStyle: 'width="12%"', sortable: true},
      {title: 'Disabled?', thStyle: 'width="8%"', field: 'disabled', sortable: true},
      {title: 'Concurrent?', thStyle: 'width="8%"', field: 'concurrentBuild', sortable: true}
    ],
    query: {},
    jenkinsUrls: [],
    nodeParams: [],
