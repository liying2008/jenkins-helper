new Vue({
  ...
  data: {
    strings: {
      ...
      workingDirectory: chrome.i18n.getMessage("workingDirectory"),
      remainingDiskSpace: chrome.i18n.getMessage("remainingDiskSpace"),
      responseTime: chrome.i18n.getMessage("responseTime"),
      isMonitoring: chrome.i18n.getMessage("isMonitoring"),
    },
    inputUrlValue: '',
    nodes: {},
    monitoredNodes: {},
