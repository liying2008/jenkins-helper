...
export const defaultTheme: Theme = {
  ...
  light: {
    common: {
      ...
      primaryColorPressed: colors.teal.darken2,
  ...
  dark: {
    common: {
      primaryColor: colors.teal.darken3,
      primaryColorHover: colors.teal.darken2,
      primaryColorPressed: colors.teal.darken4,
      primaryColorSuppl: colors.teal.darken2,
