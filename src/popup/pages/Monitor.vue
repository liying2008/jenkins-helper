<template>
  <div id="wrapper">
    <v-text-field>
      ...
      <v-btn fab small color="teal" slot="append" @click="addJenkinsUrl">
        <v-icon color="white">mdi-plus</v-icon>
      </v-btn>
      <v-icon slot="prepend" color="teal">mdi-link-variant</v-icon>
    </v-text-field>

    <div>
      <v-card v-for="(jenkins, jenkinsUrl, index) in data">
        <v-card-title>
...
<script lang="ts">
  ...
  export default class Monitor extends Vue {
    ...
    private inputUrlValue = ''
    private btnAddDisabled = true
    private showDisabledJobs = true
    private jenkinsData: { jenkinsUrls: string[], jobStatus: any } = {
      jenkinsUrls: [],
      jobStatus: {}
    }
    private data = {}
    private filteringResult = ''
    private filteringResults = []
